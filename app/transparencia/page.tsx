...
export default function TransparenciaPage() {
  return (
    <main className="min-h-screen bg-[#f7f8fa] text-[#1b2230]">
        ...
        <div className="grid gap-4 rounded-[2rem] border border-white/60 bg-white/95 p-4 shadow-2xl shadow-slate-900/15 backdrop-blur-xl md:grid-cols-3">
          {pilares.map((item) => (
            ...
            >
              ...
              <p className="mt-4 leading-7 text-[#667085]">{item.texto}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="bg-[#edf0f5] py-14">
        <div className="mx-auto max-w-7xl px-6">
          <div className="rounded-[2rem] border border-white/70 bg-white p-7 shadow-sm md:p-9">
