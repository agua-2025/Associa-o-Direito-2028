  ...
  return (
    <main className="min-h-screen bg-[#f7f8fa] text-[#1b2230]">
      ...
      <section className="relative overflow-hidden bg-[#13233a]">
        <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(19,35,58,0.94),rgba(19,35,58,0.76),rgba(19,35,58,0.36)),url('/images/galeria-turma.jpg')] bg-cover bg-center" />
      ...
      <section className="relative z-10 mx-auto -mt-8 max-w-7xl px-6">
        <div className="grid gap-4 rounded-[2rem] border border-white/60 bg-white/95 p-4 shadow-2xl shadow-slate-900/15 backdrop-blur-xl md:grid-cols-2 lg:grid-cols-4">
          {albuns.map((album) => (
            ...
            >
              <div className="relative h-52 bg-[#13233a]">
                <div
