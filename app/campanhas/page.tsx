...
const cards = [
  {
    ...
    texto: "Campanha destinada à arrecadação de recursos para apoiar a organização da formatura.",
  },
  {
    titulo: "Eventos",
    texto: "Iniciativas presenciais ou virtuais para integração da turma e fortalecimento da arrecadação.",
  },
  {
    titulo: "Parceiros",
    texto: "Apoio de empresas, profissionais e colaboradores que desejam contribuir com a caminhada da turma.",
  },
];

const passos = [
  "A campanha será apresentada aos associados.",
  "As regras serão definidas em regulamento próprio.",
  "A divulgação será feita pelos canais oficiais da Associação.",
  "A prestação de contas será realizada internamente aos associados.",
];
  ...
  return (
    <main className="min-h-screen bg-[#f7f8fa] text-[#1b2230]">
      ...
      <section className="relative overflow-hidden bg-[#13233a]">
        <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(19,35,58,0.94),rgba(19,35,58,0.72),rgba(19,35,58,0.30)),url('/images/campanha-destaque.jpg')] bg-cover bg-center" />
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 md:py-32">
          <div className="max-w-4xl">
            ...
            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/75">
              ...
              tornar possível uma formatura bonita, planejada e memorável.
            </p>
        ...
        <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
          ...
          <div className="rounded-[2rem] border border-[#e5dacb] bg-white p-8 shadow-sm md:p-10">
            <p className="text-xl leading-9 text-[#596579]">
              ...
              turma, com arte, informações essenciais, formas de participação,
          ...
          <div className="grid gap-5 md:grid-cols-2">
            {passos.map((passo, index) => (
              ...
              >
                ...
                <p className="text-lg leading-8 text-[#596579]">{passo}</p>
              </div>
            ))}
          </div>
        </div>
